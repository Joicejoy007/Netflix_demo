...
export default function Detail({props,navigation,route}){
    ...
    useEffect(() => {
        ...
        return fetch(`https://api.themoviedb.org/3/movie/${eachMovie.data.id}/similar?api_key=86b767af21aed03f022fe5e01b409fe3&language=en-US`)
...
.catch(err => {
    ...
    const renderHeader = () => {
        return(
            ...
            <Text style={styles.title}>{eachMovie.data.title}</Text>
        <View style={styles.datecontainer}>
        <Text style={styles.releasedate}>{eachMovie.data.release_date==undefined?" ":eachMovie.data.release_date.slice(0,4)}</Text>
    ...
    return(
        ...
        <View style={[styles.searchcon,{top:insets.top}]}>
